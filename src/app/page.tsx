...
export default function Home() {
	return (
		<main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-white via-slate-100 to-slate-200 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 transition-colors duration-500">
			...
			>
				...
				<p className="text-base sm:text-lg text-slate-700 dark:text-slate-300 mb-6 text-center">
					Passionate about building robust, scalable CI/CD pipelines and
					cloud-native solutions. 7+ years of experience automating deployments,
					optimizing workflows, and enabling high-performing teams on Azure.
					Certified Azure DevOps Expert. Advocate for DevOps best practices,
					security, and continuous improvement.
				</p>
				<Link
					href="#projects"
					className="inline-block px-6 py-3 rounded-full bg-blue-700 text-white font-semibold shadow hover:bg-blue-800 dark:bg-blue-500 dark:hover:bg-blue-600 transition-colors focus:ring-2 focus:ring-blue-400 focus:outline-none"
				>
					View Projects
				</Link>
			</motion.section>
			...
			>
				...
				<div className="bg-white/90 dark:bg-slate-900/90 rounded-2xl shadow-lg p-8 border border-slate-200 dark:border-slate-800">
					...
					<div className="mt-6 text-center">
						...
						<a
							href="mailto:kundai.nyatondo@outlook.com"
							className="text-blue-700 dark:text-blue-400 font-semibold underline"
						>
							kundai.nyatondo@outlook.com
						</a>
					</div>
				</div>
			</motion.section>
